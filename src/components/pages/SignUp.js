    ...
    <div>
      ...
      <div className='rsvp-container'>
        <div className='rsvp-section'>
          ...
          <p className='rsvp-intro'>
            No gifts please! Your presence is the best present we could ask for.
          </p>

          <p className='rsvp-intro'>
            Can you bring a Plus One? Yes!
          </p>
          ...
          <form className='rsvp-form' onSubmit={handleSubmit}>
            ...
            <div className='form-section'>
              ...
              <div className='form-group'>
               ...
               <p className='rsvp-intro'>
            If you'd like to hold a speech, reach out to our toast masters - Anna and Martin!
            Anna.vernersson@outlook.com          
          </p>
